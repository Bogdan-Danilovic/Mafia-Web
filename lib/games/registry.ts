...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    id: 'spicy',
    name: 'Spicy',
    description: 'Kartičana igra blefiranja za 2–6 igrača. Igraj karte licem nadole, objavi broj i začin — istinito ili lažno.',
    shortDescription: 'Blafiraj i izazivaj!',
    icon: '🌶️',
    accentColor: '#ef4444',
    minPlayers: 2,
    maxPlayers: 6,
