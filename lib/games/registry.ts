...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    id: 'mafia',
    name: 'Mafia',
    description: 'Socijalna dedukcijska igra u kojoj mafija pokušava da eliminiše civile, a civili da otkriju mafiju glasanjem.',
    shortDescription: 'Ko je mafija? Preživi noć.',
    icon: '🔫',
    accentColor: '#dc2626',
    minPlayers: 6,
    maxPlayers: 14,
    ...
    path: '/games/mafia',
    available: true,
    tags: ['socijalna', 'dedukcija', 'glasanje', 'uloge'],
  },
  {
    id: 'cambio',
    name: 'Cambio',
